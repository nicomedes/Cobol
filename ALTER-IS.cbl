      $SET ACCEPTREFRESH
       ...
       AUTHOR.           TAKATO.
      *    ************************************************
      *    *  EXEMPLO DE ALTERACAO RANDOMICA DE ARQUIVO IS*
      *    ************************************************
      ...
      *ROTINA PARA LEITURA (PESQUISA) NO CADASTRO DE PRODUTO
           ...
           ELSE
               ...
               PERFORM  RECEBER-DADOS-PARA-ALTERACAO
               PERFORM  ROTINA-ATUALIZAR-REGISTRO
           END-IF.
      ...
      *  OPCAO PARA CONTINUAR OU PARAR
       ...
       EXIBIR-DADOS-DO-REGISTRO.
           ...
           DISPLAY  D2
           DISPLAY  D3.
       RECEBER-DADOS-PARA-ALTERACAO.
      *   NAO PERMITE ALTERAR O CODIGO DE PRODUTO
           ACCEPT    D2
           ACCEPT    D3.
       ROTINA-ATUALIZAR-REGISTRO.
      *  OPCAO PARA ATUALIZAR OU DESCARTAR ALTERACAO
